#ifndef SINGULARITY_LAYER_H
#define SINGULARITY_LAYER_H
...
namespace Nova::App {
    ...
    public:
        explicit SingularityLayer() : Nova::Core::Layer("SingularityLayer") {}
        ~SingularityLayer() override;
